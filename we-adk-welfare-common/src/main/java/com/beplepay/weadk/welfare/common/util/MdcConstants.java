package com.beplepay.weadk.welfare.common.util;

/**
 * MDC(Mapped Diagnostic Context) 키 상수 클래스.
 *
 * <p>logback-spring.xml의 {@code %X{traceId:-NO_TRACE}} 패턴과
 * {@link com.beplepay.weadk.welfare.common.filter.TraceIdFilter},
 * {@link com.beplepay.weadk.welfare.common.http.HttpLoggingInterceptor}에서
